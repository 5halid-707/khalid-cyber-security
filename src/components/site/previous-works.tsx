...
const works: Work[] = [
  ...
  },
  {
    ...
    description: {
      ar: "تطبيق محادثات فورية نسخة طبق الأصل من WhatsApp Web — شاشة دخول بـ QR Code، قائمة محادثات بـ 10 جهات اتصال، فقاعات رسائل بتصميم واتساب (خضراء للمرسلة + بيضاء للمستلمة)، علامات ✓✓ زرقاء (مقروءة)، ردود تلقائية، مؤشر كتابة، بحث، منتقي إيموجي، إعدادات + ملف شخصي، 60+ رسالة عربية/إنجليزية، مبني بـ Next.js + React + TypeScript.",
      en: "Exact WhatsApp Web clone — QR code login screen, 10 mock conversations, WhatsApp-style chat bubbles (green sent + white received), blue ✓✓ read ticks, auto-replies, typing indicator, search, emoji picker, settings + profile, 60+ bilingual messages, built with Next.js + React + TypeScript.",
    },
    tech: ["Next.js", "React", "TypeScript", "Tailwind", "WhatsApp Clone", "QR Login", "Chat Bubbles", "Auto-Reply", "Emoji Picker", "10 Conversations"],
    liveUrl: "https://whatsapp-web-clone-5halid-707s-projects.vercel.app/",
  ...
  },
  {
    ...
    titleAr: "SHEIN — متجر أزياء إلكتروني",
    category: { ar: "متجر إلكتروني شامل", en: "Full E-Commerce Store" },
    categoryColor: "#ee296d",
    description: {
      ar: "متجر إلكتروني احترافي نسخة طبق الأصل من SHEIN بكل مميزاته — شعار SHEIN، صور منتجات حقيقية، Hero carousel، Flash Sale مع countdown timer، 27 منتج عبر 6 فئات (نسائي/رجالي/أطفال/تجميل/منزل/إكسسوارات)، صفحة تفاصيل المنتج مع gallery + مقاسات + ألوان + تقييمات، سلة تسوق + كوبونات خصم (SHEIN15)، صفحة دفع كاملة بـ 5 طرق دفع، صفحة فئات مع فلاتر، مفضلة، صفحة حساب، RTL عربي كامل.",
      en: "Professional SHEIN exact clone e-commerce store with all features — SHEIN logo, real product images, Hero carousel, Flash Sale countdown timer, 27 products across 6 categories, product detail with gallery + sizes + colors + reviews, cart with discount coupons (SHEIN15), full checkout with 5 payment methods, category pages with filters, wishlist, account page, full Arabic RTL.",
    },
