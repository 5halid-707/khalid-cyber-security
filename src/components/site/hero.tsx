...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      />
      {/* Floating glow orbs */}
      <div className="absolute top-1/4 right-[15%] w-40 h-40 rounded-full bg-neon-green/10 blur-3xl animate-glow-pulse" />
      <div className="absolute bottom-1/4 left-[15%] w-52 h-52 rounded-full bg-neon-blue/10 blur-3xl animate-glow-pulse" />

      <p className="font-mono text-sm md:text-base text-neon-green/80 mb-4 tracking-widest">
      ...
      <div className="h-12 md:h-14 mb-10 flex justify-center">
        <div
          dir="rtl"
          className="font-mono text-2xl md:text-3xl text-neon-green border-r-4 border-neon-green pr-3 cursor-blink"
      ...
      {/* Scroll hint */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-fg/40">
