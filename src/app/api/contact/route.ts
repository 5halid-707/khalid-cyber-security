 ...
 * Sends:
 *   1. Email notification to kmalharbi.c@gmail.com (via Gmail SMTP)
...
const OWNER_EMAIL = process.env.EMAIL_TO || "kmalharbi.c@gmail.com";
const FROM_EMAIL = process.env.EMAIL_FROM || "kmalharbi.c@gmail.com";
