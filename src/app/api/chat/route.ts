...
4. WhatsApp Clone — تطبيق محادثات — https://whatsapp-web-clone-5halid-707s-projects.vercel.app/
...
- إذا سُئلت عن الأعمال المنجزة، اذكر 9 مشاريع حقيقية مع روابطها: KMHflix (Netflix)، Amazon، Instagram، WhatsApp، Haraj، Uber، The Ritz-Carlton Jeddah، SHEIN (متجر أزياء نسخة طبق الأصل)، Sephora (متجر مستحضرات تجميل نسخة طبق الأصل).
...
function getOfflineReply(message: string, isAr: boolean): string {
  ...
  if (isAr) {
    ...
    if (has(["أعمال", "مشاريع", "portfolio", "project", "أمثلة", "نماذج", "اعمال"])) {
      return pick([
        "أنجزت 8 مشاريع حقيقية على الإنترنت 🚀 — كلها معاينة مباشرة:\n\n🎬 Netflix Clone — kmhflix.netlify.app\n🛒 Amazon Clone — متجر إلكتروني متكامل\n📸 Instagram Clone — تطبيق اجتماعي ثنائي اللغة\n💬 WhatsApp Clone — محادثات فورية\n🚗 Haraj — سوق إعلانات سعودي (20+ قسم)\n🚙 Uber Clone — تتبع + حجز رحلات\n🏨 فندق Ritz-Carlton Jeddah — hotel-ritz.vercel.app\n👗 SHEIN — متجر أزياء نسخة طبق الأصل (shein-store-teal.vercel.app)\n\nكل مشروع مبني بتقنيات حديثة: React, Next.js, TypeScript, Tailwind. جرّبها بنفسك! 🎯",
        "مشاريعي تتكلم عن نفسها 💪:\n\nأحدثها: متجر SHEIN — نسخة طبق الأصل من SHEIN بكل مميزاته، شعار SHEIN، صور منتجات حقيقية، 27 منتج عبر 6 فئات، Hero carousel، Flash Sale مع countdown، سلة + كوبونات خصم (SHEIN15)، 5 طرق دفع، مفضلة، صفحة حساب. مبني بـ Next.js + TypeScript + RTL. 🔥\n\nقبلها: فندق Ritz-Carlton (لوحة تحكم + حجوزات)، حراج، Uber، Netflix/Amazon/Instagram/WhatsApp clones.\n\n8 مشاريع حقيقية = خبرة مثبتة وليست ادعاء. 🏆 شاهد: shein-store-teal.vercel.app",
        "كل مشروع أنجزته يحكي قصة احترافية 📚:\n\n1️⃣ Netflix — منصات بث متقدمة\n2️⃣ Amazon — متاجر إلكترونية\n3️⃣ Instagram — تطبيقات اجتماعية ثنائية اللغة\n4️⃣ WhatsApp — محادثات real-time\n5️⃣ Haraj — منصات إعلانات (PWA + offline)\n6️⃣ Uber — تكامل خرائط + تتبع\n7️⃣ Ritz-Carlton — مواقع فندقية فاخرة + dashboards\n8️⃣ SHEIN — متجر أزياء نسخة طبق الأصل (27 منتج + Flash Sale + checkout)\n\nكل مشروع رفع مستوى خبرتي. مشروعك القادم سيكون تحفتي التاسعة! 🎨 +966575015019",
      ]);
    }
